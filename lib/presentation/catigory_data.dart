...
List<CategoryData> categoryData = [
  ...
  CategoryData(icon: "assets/icons_ellips/03.svg", title: "Restoran/Kafe", color: Colors.white),
  CategoryData(icon: "assets/icons_ellips/04.svg", title: "Ish", color: Colors.white),
  CategoryData(icon: "assets/icons_ellips/05.svg", title: "Pul o’tkazmalari", color: Colors.white),
  CategoryData(icon: "assets/icons_ellips/06.svg", title: "Ehson/Zakot", color: Colors.white),
  CategoryData(icon: "assets/icons_ellips/07.svg", title: "Shopping", color: Colors.white),
  CategoryData(icon: "assets/icons_ellips/08.svg", title: "Yangi kategoriya qo'shish", color: Colors.white),
];
